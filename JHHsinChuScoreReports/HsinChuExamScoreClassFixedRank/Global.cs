    ...
    public class Global
    {
        ...
        public static void ExportMappingFieldWord()
        {
            ...
            try
            {
                ...
                builder.Writeln("");
                builder.Writeln("");
                builder.Writeln("班級、年級領域成績組距-領域成績");
                builder.StartTable();
                builder.CellFormat.Borders.LineStyle = LineStyle.None;
                ...
                builder.Writeln("");
                builder.Writeln("");
                builder.Writeln("班級、年級科目成績組距-科目成績");
                builder.StartTable();
                builder.CellFormat.Borders.LineStyle = LineStyle.None;
                ...
                for (int r = 1; r <= 30; r++)
                {
                    ...
                    builder.InsertCell();
                    builder.InsertField("MERGEFIELD 學生_領域學分" + r + " \\* MERGEFORMAT ", "分");
                    builder.InsertCell();
                    builder.InsertField("MERGEFIELD 學生_科目名稱" + r + " \\* MERGEFORMAT ", "科");
                    builder.InsertCell();
                    builder.InsertField("MERGEFIELD 學生_科目學分" + r + " \\* MERGEFORMAT ", "分");
                    builder.EndRow();
                }
                builder.EndTable();
