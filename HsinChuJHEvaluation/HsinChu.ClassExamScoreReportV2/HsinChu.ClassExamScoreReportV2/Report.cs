...
namespace HsinChu.ClassExamScoreReportV2
{
    internal class Report
    {
        ...
        public static string _SelectItemName = "";
        ...
        public Workbook Output()
        {
            ...
            foreach (JHClassRecord each in Classes)
            {
                ...
                OutputSheet.Cells[title.FirstRow + ClassOffset, title.FirstColumn].PutValue(string.Format("{0} {1}學年度第{2}學期 {4} {3} 班級" + _SelectItemName + "評量成績單", SchoolName, SchoolYear, Semester, ExamName, each.Name));
