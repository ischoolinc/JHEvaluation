...
namespace KaoHsiung.TransferReport
{
    public class Report
    {
        ...
        public Report(Config config)
        {
            ...
            _domains.AddRange(JHSchool.Evaluation.Domain.SelectGeneral());
            _domains.Add("彈性課程");
            _domains.AddRange(JHSchool.Evaluation.Domain.SelectSpecial());
            _config = config;
        ...
        private void InitializeTemplate()
        {
            ...
            _template = new Document(new MemoryStream(Properties.Resources.高雄轉學成績證明書));
        }
