...
namespace KaoHsiung.ReaderScoreImport_SubjectMakeUp
{
    public partial class ExamCodeConfig : BaseForm
    {
        ...
        private List<ExamCode_SubjectMakeUp> _list;
        ...
        {
            _list = _accessHelper.Select<ExamCode_SubjectMakeUp>();
            //if (_list.Count <= 0)
        ...
        protected void Save()
        {
            ...
            List<ExamCode_SubjectMakeUp> newList = new List<ExamCode_SubjectMakeUp>();
            foreach (DataGridViewRow row in dataGridViewX1.Rows)
            {
                if (row.IsNewRow) continue;

                ExamCode_SubjectMakeUp cc = new ExamCode_SubjectMakeUp();
