...
namespace KaoHsiung.ReaderScoreImport_SubjectMakeUp
{
    public partial class ClassCodeConfig : BaseForm
    {
        ...
        private List<ClassCode_SubjectMakeUp> _list;
        ...
        {
            _list = _accessHelper.Select<ClassCode_SubjectMakeUp>();
            //if (_list.Count <= 0)
        ...
        protected void Save()
        {
            ...
            List<ClassCode_SubjectMakeUp> newList = new List<ClassCode_SubjectMakeUp>();
            foreach (DataGridViewRow row in dataGridViewX1.Rows)
            {
                if (row.IsNewRow) continue;

                ClassCode_SubjectMakeUp cc = new ClassCode_SubjectMakeUp();
