...
namespace JHEvaluation.StudentScoreSummaryReport
{
    public partial class PrintForm_StudentScoreCertificattion : BaseForm, IStatusReporter
    {
        ...
        public PrintForm_StudentScoreCertificattion(List<string> studentIds)
        {
            ...
            Preference = new ReportPreference(ConfigName, Properties.Resources.在校成績證明書_樣版_202510);
        ...
        private void MasterWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            table.Columns.Add("出生日期_西元年");
            table.Columns.Add("出生日期_民國年");
            ...
            foreach (string stuID in StudentIDs)
            {
                ...
                if (sr_dict.ContainsKey(stuID))
                {
                    ...
                    row["出生日期_西元年"] = birthday.ToString("yyyy/MM/dd");
                                    ...
                                    foreach (var subjectscore in jssr.Subjects)
                                    {
                                        ...
                                        if (subjectscore.Value.Domain == "彈性課程" || subjectscore.Value.Domain == "彈性學習" || subjectscore.Value.Domain == "")
                                        {
                                            if (AlternativeCourseDict.ContainsKey(subjectscore.Value.Subject))
                                            {
                                                ...
                                                {
                                                    subjectLevel_dict["彈性課程_科目" + AlternativeCourse + "_等第" + (grade * 2 - 1)] = _ScoreMappingConfig.ParseScoreName(subjectscore.Value.Score);
                                                }
                                        ...
                                        else
                                        {
                                            if (SubjectCourseDict.ContainsKey(subjectscore.Value.Domain))
                                            {
                                                if (SubjectCourseDict[subjectscore.Value.Domain].ContainsKey(subjectscore.Value.Subject))
                                                {
                                                    ...
                                                    {
                                                        subjectLevel_dict[subjectscore.Value.Domain + "_科目" + SubjectCourseNum + "_等第" + (grade * 2 - 1)] = _ScoreMappingConfig.ParseScoreName(subjectscore.Value.Score);
                                                    }
                                    ...
                                    foreach (var subjectscore in jssr.Subjects)
                                    {
                                        ...
                                        if (subjectscore.Value.Domain == "彈性課程" || subjectscore.Value.Domain == "彈性學習" || subjectscore.Value.Domain == "")
                                        {
                                            if (AlternativeCourseDict.ContainsKey(subjectscore.Value.Subject))
                                            {
                                                ...
                                                {
                                                    subjectLevel_dict["彈性課程_科目" + AlternativeCourse + "_等第" + (grade * 2)] = _ScoreMappingConfig.ParseScoreName(subjectscore.Value.Score);
                                                }
                                        ...
                                        else
                                        {
                                            if (SubjectCourseDict.ContainsKey(subjectscore.Value.Domain))
                                            {
                                                if (SubjectCourseDict[subjectscore.Value.Domain].ContainsKey(subjectscore.Value.Subject))
                                                {
                                                    ...
                                                    {
                                                        subjectLevel_dict[subjectscore.Value.Domain + "_科目" + SubjectCourseNum + "_等第" + (grade * 2)] = _ScoreMappingConfig.ParseScoreName(subjectscore.Value.Score);
                                                    }
        ...
        {
            ReportTemplate defaultTemplate = new ReportTemplate(Properties.Resources.在校成績證明書_樣版_202510, TemplateType.Word);
